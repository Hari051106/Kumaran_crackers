...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/orders', label: 'Orders', icon: icon('M6 4h12l1 16H5L6 4zm3 4a3 3 0 006 0') },
  { to: '/customers', label: 'Customers', icon: icon('M16 19v-2a4 4 0 00-8 0v2M12 11a3 3 0 100-6 3 3 0 000 6z') },
